...
function removeAddText() {
  ...
  text.remove();
  document.getElementsByClassName('textarea-div')[0].style.backgroundImage='none';
  document.getElementsByClassName('textarea-div')[0].style.height = '1em';
  document.getElementsByClassName('div-wand')[0].remove();
  document.getElementsByClassName('div-wand')[0].remove();
}
